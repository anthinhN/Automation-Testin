...
public class TestLB4CreationTime {
    ...
    public void createLoadBalancer() {
        vLBService.createLoadBalancer4(loadBalancerName);
    }
    ...
    public void createPool() {
        vLBService.createPoolWithAttachedMemberForLayer4LoadBalancer(poolName, loadBalancerName);
    }
    ...
    public void createListener() {
        vLBService.createUDPListenerForLayer4LoadBalancer(listenerName, poolName, loadBalancerName);
    }
    ...
    public void writeToExcelFile() {
        ...
        List<Map<String, Object>> data = List.of(
                Map.of(
                        ...
                        "LB Creation Time", loadBalancerCreationTimeSeconds,
                        "Pool Creation Time", poolCreationTime,
                        "Listener Creation Time", listenerCreationTime));
